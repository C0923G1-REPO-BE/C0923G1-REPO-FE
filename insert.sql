...
value('KẺ KHÔNG THỂ GIÃ TỪ',480000,30,'2023-12-01','https://www.netabooks.vn/Data/Sites/1/Product/69886/ke-khong-the-gia-tu.jpg','KIỆT TÁC TRINH THÁM ĐƯỢC MURAKAMI ĐÁNH GIÁ RẤT CAO!Một vụ án chưa giải quyết xong, một vụ án khác lại đến.
...
('NỖI NIỀM CỦA THÁM TỬ GALILEO',167000,20,'2023-12-01','https://cdn0.fahasa.com/media/flashmagazine/images/page_images/noi_niem_cua_tham_tu_galileo/2023_10_05_16_43_14_1-390x510.jpg','Một lá thư kỳ quái được gửi đến Sở cảnh sát Tokyo từ kẻ tự xưng "Bàn tay của ác ma" 
...
('NGỤY CHỨNG CỦA SOLOMON',267000,10,'2022-07-22','https://45cm.s3.ap-southeast-1.amazonaws.com/images-ch/giai-tri-the-thao-so-thich/mua-ban-sach/0/100243144/1000/e6faaf925702ddbebefb2e1525332f24-2795546346918289046.jpg','Hai người bạn cùng lớp chết không rõ ràng. Giới truyền thông đưa tin đầy thiên kiến. 
...
('PHÍA SAU NGHI CAN X',100000,10,'2022-04-21','https://niemlam.files.wordpress.com/2015/11/phia-sau-nghi-can-x-1.gif','Khi nhấn chuông cửa nhà nghi can chính của một vụ án mới, 
...
('THÁM TỬ GÀ MỜ',150000,10,'2020-05-12','https://upload.wikimedia.org/wikipedia/vi/6/6a/Th%C3%A1m_t%E1%BB%AD_g%C3%A0_m%C6%A1_poster.jpg','Kết hợp một chút hài hước kiểu Phá án sau bữa tối, 
...
('TRĂM NĂM CÔ ĐƠN',199000,35,'2023-01-06','https://nld.mediacdn.vn/2019/3/7/tramnamcodon-01-15519405458951688827263.jpg',
...
- The Times',2,6,0),
('ROMEO VÀ JULIET',199000,35,'2023-07-08','https://dnamedical.vn/wp-content/uploads/2023/09/romeo-va-juliet-pdf-2.jpg',
...
- Victor Hugo',2,7,0),
('LÁ THƯ HÈ',146000,35,'2023-10-20','https://bizweb.dktcdn.net/100/490/462/products/lathuhe.png?v=1691420522753',
...
('CUỘC ĐỜI VÀ SỐ PHẬN',400000,25,'2023-04-21','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTdyzZbYYP7t1CfQQkpzQpQWXbdSmIt-9GwvME2f95c2HW9T1vvMYHcjTDGltexC5s0ens&usqp=CAU',
...
('TIẾNG KÈN THIÊN NGA',10000,35,'2023-12-27','https://cdn0.fahasa.com/media/catalog/product/t/i/tieng_ken_thien_nga_1_2018_08_07_10_59_30.JPG',
...
('TÔN TỬ BINH PHÁP',89000,29,'2023-08-09','https://cdn0.fahasa.com/media/catalog/product/8/9/8936071674715.jpg',
...
;
insert into customer (code, name, phone, email, gender,customer_type_id,is_delete) 
value ('KH-01', 'Nguyễn Quyền', '013123123', 'Nguyenquyen171202@gmail.com', 'Nam', '1',0),
 ('AD-01', 'Quyền', '141444', '180 Trần Hưng Đạo', 'Nam', '1',0);
insert into account(username,password,customer_id,role_id,is_delete)
value('demo@minimals.cc','$12$NXLyHYb4IQskDO/NRBfuGuMCP5ik3eYF8zXfd.mrw0hlnIeskUw6m',1,1,0),
('giau@gmail.com','$12$NXLyHYb4IQskDO/NRBfuGuMCP5ik3eYF8zXfd.mrw0hlnIeskUw6m',2,2,0);
